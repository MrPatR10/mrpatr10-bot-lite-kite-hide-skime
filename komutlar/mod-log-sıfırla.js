...
exports.run = async (client, message, args) => {
  ...
  if(!modlogs) {
    return message.channel.send(`:warning: Bu sunucuda daha önceden modlog kanalı ayarlanmamış. Ayarlamak için: \`${prefix}mod-log-ayarla <#kanal>\``)
  } else {
    if(modlogs) {    
...
exports.help = {
    name: 'modlog-sıfırla',
    description: 'Log kanalını sfırlar.',
